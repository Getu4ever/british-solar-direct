...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Bifacial Solar Panels 540W',
    brand: 'JA Solar',
    priceInPence: 5900,
    image: '/images/deepblue.webp',
    ...
    moq: '5 Pallets (155 units)',
    description:
      'Dual-sided panels that generate power from both sides by absorbing direct sunlight and reflected light from the ground. Ideal for ground-mount, carport, and white-roof commercial installs.',
    category: 'Commercial / Ground-Mount',
    power: '540W',
    availability: 'Forward order',
    leadTime: 'Project and container supply',
  },
  {
    ...
    name: 'Perovskite Solar Cells 500W',
    brand: 'Oxford PV',
    priceInPence: 7600,
    image: '/images/tiger-neo.webp',
    ...
    palletQty: '36 Panels',
    containerQty: '936 Panels (26 Pallets)',
    moq: '5 Pallets (180 units)',
    description:
      'Next-generation, highly efficient cells made from a unique crystal structure that can be layered onto flexible surfaces. Delivers exceptional output for high-performance project requirements.',
    category: 'Next-Generation / R&D Supply',
    power: '500W',
    availability: 'Forward order',
    leadTime: '8-12 week lead time',
  },
  {
    slug: 'transparent-solar-glass',
    name: 'Transparent Solar Glass 350W',
    brand: 'Onyx Solar',
    priceInPence: 8900,
    image: '/images/vertex.webp',
    ...
    efficiency: '18.5%',
    weight: '24.5 kg',
    dimensions: '2000 × 1000 × 12 mm',
    palletQty: '20 Panels',
    containerQty: '400 Panels (20 Pallets)',
    moq: 'Project quote required',
    description:
      'Solar cells integrated into windows and skylights, turning standard glass surfaces into clean energy generators. Suited to facades, atriums, and architectural BIPV applications.',
    category: 'Architectural / BIPV',
    power: '350W',
    availability: 'Forward order',
    leadTime: 'Project specification required',
  },
  {
    slug: 'organic-solar-cells',
    name: 'Organic Solar Cells (OSC) 120W',
    brand: 'Heliatek',
    priceInPence: 3650,
    image: '/images/ultrablack.webp',
    type: 'Organic Photovoltaic (OPV) Flexible',
    efficiency: '13.2%',
    weight: '2.8 kg',
    dimensions: '3000 × 600 × 2 mm (rollable)',
    palletQty: '100 Panels',
    containerQty: '2,000 Panels (20 Pallets)',
    moq: '1 Pallet (100 units)',
    description:
      'Carbon-based, lightweight, and eco-friendly flexible cells ideal for irregular surfaces and portable tech. Perfect for curved structures, mobile applications, and low-light environments.',
    category: 'Flexible / Portable',
    power: '120W',
    availability: 'Forward order',
    leadTime: '4-6 week lead time',
  },
  {
    slug: 'n-type-topcon-panels',
    name: 'N-Type TOPCon Panels 520W',
    brand: 'LONGi',
    priceInPence: 5150,
    image: '/images/himo.webp',
    type: 'N-type TOPCon Monocrystalline',
    ...
    palletQty: '31 Panels',
    containerQty: '620 Panels (20 Pallets)',
    moq: '1 Pallet (31 units)',
    description:
      'Advanced silicon technology that minimises power loss and offers superior performance in low-light environments. Excellent temperature coefficient for reliable year-round output.',
    category: 'Commercial / Industrial',
    power: '520W',
    availability: 'In UK stock',
    leadTime: '2-4 working days',
