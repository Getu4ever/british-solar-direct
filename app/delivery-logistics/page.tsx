      ...
      <div className="flex-1">
        ...
        <section className="border-y border-slate-200 bg-white">
          <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6">
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">UK delivery areas</h2>
            <p className="mt-2 max-w-2xl text-sm text-slate-500">
              Core residential coverage across the East Midlands and bordering counties, with wider
              mainland delivery available by arrangement.
            </p>

            <div className="mt-6 mb-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {deliveryRegions.map((region) => (
                <div
                  key={region}
                  className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all hover:border-amber-500/30"
                >
            ...
            <div className="flex items-start gap-2 rounded-xl border border-slate-800 bg-slate-900 p-4 text-xs text-slate-300">
              <MapPin className="mt-0.5 h-3.5 w-3.5 shrink-0 text-amber-400" aria-hidden="true" />
              <p>
                {DELIVERY_EXCLUSIONS.join(' · ')}. Other UK mainland locations may be available —
                include your postcode in your quote request and we will confirm.
              </p>
            </div>
          </div>
        </section>
